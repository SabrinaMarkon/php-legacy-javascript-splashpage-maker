<html>
<head>
<title>Demo Admin Splashpage Maker and Management Site</title>
...
<body>
<center><a href="http://phpsitescripts.com"><img src="images/header.jpg" valign=top border=0></a>
<!-- START TOP MENU -->
         ...
         <td>
          <table cellpadding="0" cellspacing="0" border="0" width="960">
             <tr align="center" style='height: 40px;'>
					...
					<td class='divider'></td>
                    <td class='left_inactive'></td><td class='center_inactive'><a href='mailto:sabrina@phpsitescripts.com' class='menu'>Contact</a></td><td class='right_inactive'></td>
					<td class='divider'></td>
                </tr>
            </table></td>
       </tr>
